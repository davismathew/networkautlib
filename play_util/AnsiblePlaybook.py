#!/var/www/html/ansibengineapi/flask/bin/python2.7
import os
import sys
...
class AnsiblePlaybook:
  ...
  def __init__(self,playbook_path,host_list,stdoutfile):
      self.playbook_path='/var/ansible/Network-automation/'+str(playbook_path).strip()

      self.host_list='/var/ansible/Network-automation/'+str(host_list).strip()
...
#    self.playbook_path = '/home/davis/Documents/Network-automation/cisco_xe.yml'
    ...
    variable_manager.extra_vars = {'ansible_user': 'davis', 'ansible_password': 'fallback'} # Here are the variables used in the winclones.yml
